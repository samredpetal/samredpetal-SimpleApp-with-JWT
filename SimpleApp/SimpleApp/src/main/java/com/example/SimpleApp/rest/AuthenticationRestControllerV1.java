...
import com.example.SimpleApp.security.JwtTokenProvider;
...
public class AuthenticationRestControllerV1 {
    ...
    public ResponseEntity<?> authenticate(@RequestBody AuthenticationRequestDTO request) {
        ...
        try {
            ...
            User user = userRepository.findByEmail(request.getEmail()).orElseThrow(()-> new UsernameNotFoundException("User dos not exists"));
